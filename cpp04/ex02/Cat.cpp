...
Cat::Cat() : AAnimal(), catBrain(new Brain())
{
	this->type = "Cat";
...
/*
   This constructor first calls the AAnimal copy constructor to copy all base class attributes.
...
*/
Cat::Cat(const Cat &cpy) : AAnimal(cpy), catBrain(new Brain(*cpy.catBrain))
{
 ...
 *
 * Performs a deep copy of the given Cat object. It first copies the base AAnimal part,
...
Cat& Cat::operator=(const Cat& assign)
{
	if (this != &assign)
	{
		AAnimal::operator=(assign); //copies AAnimalanimal part
		if (this->catBrain)
